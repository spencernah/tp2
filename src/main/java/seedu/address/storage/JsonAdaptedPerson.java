...
class JsonAdaptedPerson {
    ...
    public JsonAdaptedPerson(@JsonProperty("name") String name, @JsonProperty("phone") String phone,
            ...
            @JsonProperty("group") String group, @JsonProperty("favourite") Boolean favourite) {
        this.name = name;
        this.phone = phone;
        this.email = email;
    ...
    public JsonAdaptedPerson(Person source) {
        ...
        favourite = source.getFavourite().favourite;
    }
    ...
    public Person toModelType() throws IllegalValueException {
        ...
        return new Person(modelName, modelPhone, modelEmail, modelAddress, modelRemark, modelTags, modelGroup, modelFavourite);
    }
